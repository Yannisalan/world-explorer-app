<?php
/**
 * Lists the signed-in user's visited countries.
 *
 * Mirrors get_wishlist.php. This endpoint did not exist while visited.php
 * rendered the list server-side; the page is now static and has to ask.
 */
include "config.php";
session_start();
